...
png(file="plot4.png")
par(mfrow=c(2,2))
par(mar=c(4,3.75,4,3.75))
# make 4 panel figure as one matching plot4
#plot1
par(new=F)
...
axis(1, at=c(1,1440,2880), labels=c('Thu','Fri','Sat'))
legend("topright",lty=1,col=c("black",'red','blue'),legend=c('Sub_metering_1','Sub_metering_2','Sub_metering_3'),bty='n',text.font = 2.5)
par(new=F)
